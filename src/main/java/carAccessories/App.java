...
public class App {
			...
			switch (select) {
						...
						if (productCatalog.getAllCategories().get(categoryIndex).getAllProducts()
							...
							switch (select2) {
								case 1:
									...
									productCatalog.getAllCategories().get(categoryIndex).getAllProducts().set(
											productNumber,
											newProduct2);
									System.out.println("Product Edited Successfully.\n");
									break;
								case 2:
									productCatalog.getAllCategories().get(categoryIndex).getAllProducts()
				...
				case 10:
					...
					if (adminDashboard.getInstallationRequests().size() > (requestNumber) && requestNumber >= 0) {
						System.out.println("1. Change State Request");
						...
						switch (select2) {
							case 1:
								// change state
								System.out.println("Enter New State => Accepted, Rejected: ");
	...
	public static void installerActivities() {
		...
		while (true) {
			...
			System.out.println("2. View Pending Installation Requests");
			System.out.println("3. Change Email");
			System.out.println("4. Change Contact Number");
			System.out.println("5. View Profile");
